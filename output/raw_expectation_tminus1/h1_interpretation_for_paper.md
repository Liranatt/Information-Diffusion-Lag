...
## Bottom line
The primary candidate-level H1 test supports a real positive expectation: N=890, mean=+1.3497%, median=+0.2710%, win rate=52.36%, 95% BCa CI=[+0.7880%, +1.9383%], iid bootstrap p=<0.0001.
The duplication controls keep the expectation positive: symbol-day mean +0.6490% over N=763; event-level mean +1.2709% over N=808.
